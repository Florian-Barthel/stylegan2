...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='ppl_label_wend', func_name='metrics.perceptual_path_length_label_mapping.PPL',num_samples=50000, epsilon=1e-4, space='w', sampling='end', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
    EasyDict(name='ppl_label_wfull', func_name='metrics.perceptual_path_length_label_mapping.PPL', num_samples=50000, epsilon=1e-4, space='w', sampling='full', crop=True, minibatch_per_gpu=4, Gs_overrides=dict(dtype='float32', mapping_dtype='float32')),
