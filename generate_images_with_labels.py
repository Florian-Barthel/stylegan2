...
if __name__ == "__main__":
    tflib.init_tf()
    network_pkl = 'results/00023-stylegan2-all_cars_all_labels_256-2gpu-config-f/network-snapshot-018950.pkl'
    _G, _D, Gs = misc.load_pkl(network_pkl)
    latents = np.random.normal(0, 1, [12, 1, Gs.input_shape[1]])
    generate_images_color_labels('test_labels/colors-018950-1.0.png', Gs, w=256, h=256, num_labels=97, latents=latents,
                                 truncation=1.0)
