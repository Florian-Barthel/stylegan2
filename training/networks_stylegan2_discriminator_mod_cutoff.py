...
def get_weight(shape, gain=1, use_wscale=True, lrmul=1.0, weight_var='weight'):
...
def dense_layer(x, fmaps, gain=1, use_wscale=True, lrmul=1.0, weight_var='weight'):
    if len(x.shape) > 2:
...
def apply_bias_act(x, act='linear', alpha=None, gain=None, lrmul=1.0, bias_var='bias'):
